...
def _generate_info_pic_internal(data, pinfo):
    ...
    draw.text((575 - w, 470), normal_quest_text, font_black, font_resize)
    w, h = font_resize.getsize("H" + hard_quest_text +
                           "/VH" + very_hard_quest_text)
    draw.text((575 - w, 500), "H" + hard_quest_text +
              "/VH", font_black, font_resize)
    w, h = font_resize.getsize(very_hard_quest_text)
    draw.text((575 - w, 500), very_hard_quest_text, font_black, font_resize)
    w, h = font_resize.getsize(talent_quest_text)
    draw.text((575 - w, 530), talent_quest_text, font_black, font_resize)
    ...
    draw.text((575 - w, 598), arena_time_text, font_black, font_resize)
    w, h = font_resize.getsize(arena_group_text+"场")
    draw.text((575 - w, 630), arena_group_text+"场", font_black, font_resize)
    w, h = font_resize.getsize(arena_rank_text+"名")
    draw.text((575 - w, 662), arena_rank_text+"名", font_black, font_resize)
    w, h = font_resize.getsize(grand_arena_time_text)
    draw.text((575 - w, 704), grand_arena_time_text, font_black, font_resize)
    w, h = font_resize.getsize(grand_arena_group_text+"场")
    draw.text((575 - w, 738), grand_arena_group_text+"场", font_black, font_resize)
    w, h = font_resize.getsize(grand_arena_rank_text+"名")
    draw.text((575 - w, 772), grand_arena_rank_text+"名", font_black, font_resize)
    ...
    draw.text((575 - w, 844), unit_num_text, font_black, font_resize)
    w, h = font_resize.getsize(open_story_num_text)
    draw.text((575 - w, 880), open_story_num_text, font_black, font_resize)

...
# 因此这里每天13点左右自动更新版本号
# JAG: 搜内一般维护到6pm，我们改到8pm更新版本号
@sv.scheduled_job('cron', hour='20', minute='1')
